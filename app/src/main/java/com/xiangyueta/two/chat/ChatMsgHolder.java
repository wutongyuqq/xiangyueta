		...
		public void setHolderData(Object o, int position) {
			if (o != null) {
				...
				if (bean.getFromUser() != null) {
					if (bean.getFromUser().getUserName().equals("")) {
						//是自己的聊天
						...
						//内容背景
						MyTv_content.setBackground(MyContext.getDrawable(R.drawable.i4));
						...
						//内容背景
						MyTv_content.setBackground(MyContext.getDrawable(R.drawable.i2));
